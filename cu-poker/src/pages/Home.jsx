    ...
    >
      ...
      >
        <div className="w-[90%] md:w-[80%] h-[300px] md:h-[350px] flex flex-col items-center p-4 md:p-6 shadow-xl rounded-xl">
          ...
          />
          <h1 className="text-[50px] md:text-[90px] text-text text-center">
            Columbia Poker Club
          </h1>
        </div>
      </div>
      ...
      {/* About */}
      <section className="w-full bg-white py-10 md:py-20 px-5 md:px-10 flex flex-col items-center">
        <div className="max-w-3xl md:max-w-5xl flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 p-4 md:p-6">
            <h2 className="text-4xl md:text-6xl font-bold text-primary mb-4">About Us</h2>
      ...
      {/* Upcoming Events */}
      <section className="w-full bg-gray-100 py-10 md:py-20 px-5 md:px-10">
        <div className="max-w-[90%] md:max-w-[80%] mx-auto text-center">
          <h2 className="text-4xl md:text-6xl font-bold text-primary mb-4 md:mb-6">
            Upcoming Events
          </h2>
          <p className="text-xl md:text-3xl text-gray-600 mb-6 md:mb-10">
            Join our upcoming poker tournaments and club meetups!
          </p>

          {/* Grid of Events */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
            <div className="bg-white shadow-lg p-10 md:p-20 rounded-lg border border-gray-200">
              <h3 className="text-xl md:text-2xl font-bold text-secondary mb-2">
                Club Freeplay
              </h3>
              <p className="text-gray-700 text-lg md:text-xl">Next Thursday - 8:30 PM</p>
              <p className="text-gray-700 text-lg md:text-xl">Uris Hall - 3rd Floor</p>
            ...
            <div className="bg-white shadow-lg p-10 md:p-20 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-700 text-lg md:text-xl">March 6th - 7:30 PM</p>
              <p className="text-lg md:text-xl text-gray-500 mt-2">
